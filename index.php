...
$config = [
    ...
    'routes' => [
        // 'to' => ['c' => Controller・Model名, 'a' => 許可されているアクション]
        'user' => ['c' => 'User',       'a' => ['login', 'auth', 'logout', 'upass']],
        'inst' => ['c' => 'Instrument', 'a' => ['list', 'detail', 'input', 'save', 'delete']],
        'mbr'  => ['c' => 'Member',     'a' => ['list', 'detail', 'input', 'save', 'delete', 'grant']],
        'rsv'  => ['c' => 'Reserve',    'a' => ['list', 'detail', 'input', 'save', 'delete', 'grant', 'report', 'export']],
        'stf'  => ['c' => 'Staff',      'a' => ['list', 'detail', 'input', 'save', 'delete', 'grant']],
...
try {
    ...
    // GETのみ引数展開、POSTはコントローラーで$_POST参照
    $params = $_GET;
    ...
    if (defined('DEVELOP_ENV') && DEVELOP_ENV) {
        ...
        // // 本番環境ではエラーをログに記録し、汎用的なエラーページを表示する
