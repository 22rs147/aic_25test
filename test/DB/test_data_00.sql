...
CREATE TABLE `rsv_member` (
  ...
  `reserve_id` int(11) NOT NULL COMMENT '予約番号',
  `member_id` int(11) NOT NULL COMMENT '利用者会員番号',
...
CREATE TABLE `tb_instrument` (
  ...
  `room_id` int(11) DEFAULT NULL COMMENT '設置場所部屋番号',
  `memo` text DEFAULT NULL COMMENT '備考'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tb_reserve` (
  ...
  `instrument_id` int(11) NOT NULL COMMENT '利用希望機器ID',
